...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		var8.drawStringWithShadow("Chloride Client", 2, 2, 16777215);
		var8.drawStringWithShadow("Public Alpha 1", 2, 12, 16777215);
		var8.drawStringWithShadow("x: " + this.mc.thePlayer.posX, 2, 22, 16777215);
		var8.drawStringWithShadow("y: " + this.mc.thePlayer.posY, 2, 32, 16777215);
		var8.drawStringWithShadow("z: " + this.mc.thePlayer.posZ, 2, 42, 16777215);
		var8.drawStringWithShadow("f: " + (MathHelper.floor_double((double)(this.mc.thePlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3), 2, 52, 16777215);
